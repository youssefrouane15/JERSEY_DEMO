package com.luv2kode.jersey.client;
...
import com.luv2kode.jersey.client.filter.RequestClientFilter;
import com.luv2kode.jersey.client.filter.ResponseClientFilter;
import com.luv2kode.jersey.client.interceptor.RequestClientWriterInterceptor;

public class JerseyClient {

    private static final String URI_GREETINGS = "http://localhost:8082/greetings";
